            ...
            <div>
              ...
              <div className="mt-8 flex items-center gap-3">
                ...
                <a
                  ...
                  aria-label="LinkedIn"
                  className="w-9 h-9 rounded-xl border border-white/[0.08] flex items-center justify-center text-white/30 transition-all hover:text-blue-400 hover:bg-blue-400/10 hover:border-blue-400/30 hover:scale-110"
                >
                  <Linkedin size={15} />
                </a>
                <a
                  href="#"
                  aria-label="Twitter"
                  className="w-9 h-9 rounded-xl border border-white/[0.08] flex items-center justify-center text-white/30 transition-all hover:text-sky-400 hover:bg-sky-400/10 hover:border-sky-400/30 hover:scale-110"
                >
                  <Twitter size={15} />
                </a>
                <a
                  href="#"
                  aria-label="GitHub"
                  className="w-9 h-9 rounded-xl border border-white/[0.08] flex items-center justify-center text-white/30 transition-all hover:text-white hover:bg-white/10 hover:border-white/20 hover:scale-110"
                >
                  <Github size={15} />
                </a>
              </div>
