      ...
      <div className="relative w-full max-w-md mx-4">
        <div className="bg-[#0f172a]/80 backdrop-blur-xl border border-white/10 rounded-2xl p-8 shadow-2xl">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400 mt-2 text-sm">Client / Guest Registration</p>
            <p className="text-gray-500 mt-1 text-xs">Register to request projects and track progress</p>
          </div>
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button type="submit" disabled={loading} className="w-full py-3 bg-gradient-to-r from-blue-500 to-cyan-400 text-white font-semibold rounded-xl hover:opacity-90 transition-all disabled:opacity-50 shadow-lg shadow-cyan-500/20">{loading ? "Creating..." : "Register as Client"}</button>
          </form>
